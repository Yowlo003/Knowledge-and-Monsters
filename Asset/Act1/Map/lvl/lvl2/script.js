        ...
        if (isCorrect) {
            ...
            if (playerAnswer !== null) {
                ...
                if (damageType === 'low') {
                    ...
                    highGifContainer.innerHTML = '<img src="Assets/phit1.gif" alt="Correct High GIF" width="600">';
                    ...
                    highGifContainer.innerHTML = '<img src="Assets/phit2.gif" alt="Correct High GIF" width="900">';
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "Which big cat is the largest?";
                    correctAnswer = "tiger";
                    break;
                case 1:
            ...
            switch (questionIndex) {
                case 0:
                    ...
                    correctAnswer = "female deer";
                    break;
                case 1:
                    questionText = "Which is the largest bone on the human body?";
                    correctAnswer = "thigh bone";
                    break;
                case 2:
                    questionText = "Name the bird which can mimic humans";
                    correctAnswer = "parrot";
                    break;
                case 3:
                    questionText = "How many sides are there in Octagon?";
                    correctAnswer = "8";
                    break;
                case 4:
