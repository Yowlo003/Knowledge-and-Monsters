    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What food do pandas eat?";
                ...
                case 2:
                    ...
                    break;
                case 3:
                    questionText = "The part of the eye that controls light entering the pupil is called?";
                    correctAnswer = "iris";
                    break;
                case 4:
                    questionText = "Can you name the closest star to Earth?";
                    correctAnswer = "sun";
                    break;
                default:
                    questionText = "What food do pandas eat?";
            ...
            switch (questionIndex) {
                case 0:
                    ...
                    break;
                case 1:
                    questionText = "If you double 100, what do you have?";
                    correctAnswer = "200";
                    break;
                case 2:
                    questionText = "How many minutes are in a day?";
                    correctAnswer = "1440";
                    break;
                case 3:
