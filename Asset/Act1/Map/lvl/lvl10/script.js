document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        if (isCorrect) {
            ...
            if (playerAnswer !== null) {
                ...
                if (damageType === 'low') {
                    ...
                    }, 1300); // Adjust the duration (in milliseconds) as needed
                } else {
                    damage = 34; // High damage
                    blinkplayer()

                    const highGifContainer = document.getElementById('phigh-gif-container');
                    highGifContainer.innerHTML = '<img src="Assets/phit2.gif" alt="Correct High GIF" width="750">';
        ...
        function proceedToNextLevel() {
            ...
            window.location.href = "../../../Cutscenes/C1_End/index.html";
        }

        function quitGame() {
            // Implement quit logic here
            window.location.href = "../../map10/index.html";
        }
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    ...
                    break;
                case 1:
                    questionText = "An apple and an orange together cost 4. Apple and coconut together cost 5. Two apples cost 6. Which fruit is the most expensive?";
                    correctAnswer = "apple";
                    break;
                case 2:
                    questionText = "How much is 77 x 75 x 92 x 17 x 0 x 82 x 99?";
                    correctAnswer = "0";
                    break;
                case 3:
                    questionText = "Continue the sequence: 2, 4, 8, 16, 32 …";
                    correctAnswer = "64";
                    break;
                case 4:
                    questionText = "Which metallic element is the main component of steel?";
                    correctAnswer = "iron";
                    break;
                default:
                    questionText = "What color is a giraffe's tongue?";
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "Which element has the chemical symbol N?";
                    correctAnswer = "nitrogen";
                    break;
                case 1:
                    questionText = "What is the fastest flying bird in the world?";
                ...
                case 3:
                    ...
                    break;
                case 4:
                    questionText = "We cover ourselves in materials. What do we call these materials?";
