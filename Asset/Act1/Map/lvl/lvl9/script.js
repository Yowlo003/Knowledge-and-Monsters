    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "How much is 15×5?";
                    correctAnswer = "75";
                    break;
                case 1:
                    questionText = "How much is 22 + 33 + 44 + 55?";
                    correctAnswer = "154";
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    questionText = "What color is spinach?";
                    correctAnswer = "green";
                    break;
                case 4:
                    questionText = "How many people are there in the world?";
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is a famous movie about a park with dinosaurs?";
                    correctAnswer = "jurassic park";
                    break;
                case 1:
                    questionText = "Which shape has more corners: a pentagon or a hexagon?";
                    correctAnswer = "hexagon";
                    break;
                case 2:
                    questionText = "Which astrological sign is a lion?";
                    correctAnswer = "leo";
                    break;
                case 3:
                    questionText = "What's the biggest human organ?";
                    correctAnswer = "skin";
                    break;
                case 4:
                    questionText = "In astrology, how many signs of the zodiac typically are there?";
                    correctAnswer = "12";
                    break;
                default:
                    questionText = "What is a famous movie about a park with dinosaurs?";
