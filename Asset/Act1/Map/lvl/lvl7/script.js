    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What contains more sugar, strawberries or lemons?";
                    correctAnswer = "lemons";
                    break;
                case 1:
                    questionText = "What is the largest number of these: 1, 14, 7, 11?";
                    correctAnswer = "14";
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    questionText = "Which number is greater: 4 or 6?";
                    correctAnswer = "6";
                    break;
                case 4:
                    questionText = "Which shape has three corners?";
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "Which is more: 5 meters or 5 feet?";
                    correctAnswer = "5 meters";
                    break;
                case 1:
                    questionText = "Which is more: A. 25 + 30 or B. 35 + 5? (answer only letters)";
                    correctAnswer = "a";
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    questionText = "Which is more: A. 2 hours or B. 80 minutes? (answer only letters)";
                    correctAnswer = "a";
                    break;
                case 4:
                    questionText = "Stratus, cirrus, cumulus and nimbus are types of what?";
