    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "Which planet has a moon named Titan?";
                    correctAnswer = "saturn";
                    break;
                case 1:
                    questionText = "Which planet is known for having the shortest day, completing one rotation in about 10 hours?";
                    correctAnswer = "jupiter";
                    break;
                case 2:
                    questionText = "Which constellation is known as the Archer?";
                    correctAnswer = "sagittarius";
                    break;
                case 3:
                    questionText = "Which constellation is represented by a pair of twins?";
                    correctAnswer = "gemini";
                    break;
                case 4:
                    questionText = "Which constellation is symbolized by a ram?";
                    correctAnswer = "aries";
                    break;
                default:
                    questionText = "Which planet has a moon named Titan?";
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "Which constellation is symbolized by a bull?";
                    correctAnswer = "taurus";
                    break;
                case 1:
                    questionText = "Which constellation represents a virgin or maiden?";
                    correctAnswer = "virgo";
                    break;
                case 2:
                    questionText = "Which constellation is symbolized by scales?";
                    correctAnswer = "libra";
                    break;
                case 3:
                    questionText = "Which constellation represents a crab?";
                    correctAnswer = "cancer";
                    break;
                case 4:
                    questionText = "Which constellation is symbolized by a goat or sea-goat?";
