document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        if (isCorrect) {
            ...
            setTimeout(() => {
                ...
                if (damageAmount !== null) {
                    ...
                    const timeoutDuration = containerId === "high-gif-container" ? 700 : 1000; // Adjust timeout duration as per your requirement
            ...
            if (damageAmount !== null) {
                ...
                const damage = Math.floor(Math.random() * 23) + 1; // Random damage between 1 and 20
                enemyHealth -= damage;
            }
            if (enemyHealth < 0) {
            ...
            if (playerAnswer !== null) {
                ...
                if (damageType === 'low') {
                    ...
                    highGifContainer.innerHTML = '<img src="Assets/phit1.gif" alt="Correct High GIF" width="700">';
                    ...
                    }, 900); // Adjust the duration (in milliseconds) as needed
                } else {
                    damage = 36; // High damage
                    blinkplayer()

                    const highGifContainer = document.getElementById('phigh-gif-container');
                    highGifContainer.innerHTML = '<img src="Assets/phit2.gif" alt="Correct High GIF" width="1200">';
        ...
        function proceedToNextLevel() {
            ...
            window.location.href = "../../../Cutscenes/C3_End/index.html";
        }
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "Which creature from mythology is a female spirit known for singing sailors to their doom?";
                    correctAnswer = "sirens";
                    break;
                case 1:
                    questionText = "What is the name of the winged horse in Greek mythology?";
                    correctAnswer = "pegasus";
                    break;
                case 2:
                    questionText = "Which mythical creature is a human that can transform into a wolf?";
                    correctAnswer = "werewolf";
                    break;
                case 3:
                    questionText = "What is the name of the female monster in Greek mythology with snakes for hair, who turns people to stone with her gaze?";
                    correctAnswer = "medusa";
                    break;
                case 4:
                    questionText = "Which ancient Egyptian creature has the body of a lion and the head of a human?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,14); // Player answered correctly
                } else {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the name of the three-headed dog that guards the entrance to the underworld in Greek mythology?";
                    correctAnswer = "cerberus";
                    break;
                case 1:
                    questionText = "Which mythical creature is a bird of prey with the body of a lion and the head and wings of an eagle?";
                    correctAnswer = "griffin";
                    break;
                case 2:
                    questionText = "What is the name of the legendary creature in Jewish folklore made from clay and brought to life?";
                    correctAnswer = "golem";
                    break;
                case 3:
                    questionText = "Which creature from Greek mythology is a lion with a goat's head emerging from its back and a snake for a tail?";
                    correctAnswer = "chimera";
                    break;
                case 4:
                    questionText = "Which creature in Philippine mythology is a shapeshifter that can turn into a bat-like monster and is known for eating unborn children?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,19); // Player answered correctly with high damage
                } else {
                    handleAnswer(false); // Player answered incorrectly
                }
            });
