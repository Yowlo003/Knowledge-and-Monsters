document.addEventListener('DOMContentLoaded', function() {
    ...
    function p1function() {
        if (potionCooldown) {
            return; // Ignore click if potion cooldown is active
        }
            ...
            if (potionUses > 0) {
                ...
                const highGifContainer = document.getElementById('healid1');
                    ...
                    setTimeout(() => {
                        ...
                        potionCooldown = true; // Set cooldown
                        setTimeout(() => {
                            potionCooldown = false; // Reset cooldown after delay
                        }, 1000); // Adjust the cooldown duration (in milliseconds) as needed
    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        if (isCorrect) {
            ...
            if (damageAmount !== null) {
                ...
                const damage = Math.floor(Math.random() * 26) + 1; // Random damage between 1 and 20
                enemyHealth -= damage;
            }
            if (enemyHealth < 0) {
            ...
            if (playerAnswer !== null) {
                ...
                if (damageType === 'low') {
                    damage = 17; // High damage
                    blinkplayer()

                    const highGifContainer = document.getElementById('plow-gif-container');
                    highGifContainer.innerHTML = '<img src="Assets/phit1.gif" alt="Correct High GIF" width="400">';
                    ...
                    damage = 22; // High damage
                    blinkplayer()

                    const highGifContainer = document.getElementById('phigh-gif-container');
                    highGifContainer.innerHTML = '<img src="Assets/phit2.gif" alt="Correct High GIF" width="400">';
        ...
        function proceedToNextLevel() {
            ...
            window.location.href = "../lvl6/index.html";
        }

        function quitGame() {
            // Implement quit logic here
            window.location.href = "../../map6/index.html";
        }
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the violent shaking of the ground caused by the sudden movement of rock beneath the Earth's surface?";
                    correctAnswer = "earthquake";
                    break;
                case 1:
                    questionText = "What is a group of organisms of the same species that live in a particular area and interact with each other?";
                    correctAnswer = "population";
                    break;
                case 2:
                    questionText = "What is a complex network of interconnected food chains within an ecosystem, where organisms eat and are eaten?";
                    correctAnswer = "food web";
                    break;
                case 3:
                    questionText = "What is the vast, open ocean zone away from the continents, characterized by deep water and relatively low productivity?";
                    correctAnswer = "deep sea";
                    break;
                case 4:
                    questionText = "What are the soft-bodied, bottom-dwelling marine animals with tentacles that use stinging cells to capture prey?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,21); // Player answered correctly
                } else {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What are the intelligent, social marine mammals known for their complex communication and problem-solving skills?";
                    correctAnswer = "dolphins";
                    break;
                case 1:
                    questionText = "What is a visible mass of condensed water vapor floating in the atmosphere?";
                    correctAnswer = "cloud";
                    break;
                case 2:
                    questionText = "What is a violent storm that is rotating column of air, from the thunderstorm to the ground, and have a destructive winds?";
                    correctAnswer = "tornado";
                    break;
                case 3:
                    questionText = "What is a colorful atmospheric phenomenon produced when sunlight interacts with water droplets or ice crystals in the atmosphere?";
                    correctAnswer = "rainbow";
                    break;
                case 4:
                    questionText = "What is a type of precipitation that falls in the form of frozen water crystals? it happends in winter season";
                    correctAnswer = "snow";
                    break;
                default:
                    questionText = "What are the intelligent, social marine mammals known for their complex communication and problem-solving skills?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,26); // Player answered correctly with high damage
                } else {
                    handleAnswer(false); // Player answered incorrectly
                }
            });
