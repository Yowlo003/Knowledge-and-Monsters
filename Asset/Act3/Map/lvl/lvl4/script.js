    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        if (isCorrect) {
            ...
            if (damageAmount !== null) {
                ...
                const damage = Math.floor(Math.random() * 27) + 1; // Random damage between 1 and 20
                enemyHealth -= damage;
            }
            if (enemyHealth < 0) {
        ...
        function quitGame() {
            ...
            window.location.href = "../../map5/index.html";
        }
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is a non-woody flowering plant with soft stems that typically lives for one growing season?";
                    correctAnswer = "herb";
                    break;
                case 1:
                    questionText = "What is a plant that reproduces by spores instead of seeds?";
                    correctAnswer = "fren";
                    break;
                case 2:
                    questionText = "What is a plant that stores water in its fleshy stem or leaves to survive in dry environments like dessert?";
                    correctAnswer = "cactus";
                    break;
                case 3:
                    questionText = "What is a climbing plant that uses tendrils or other structures to attach itself to a support for growth?                    ";
                    correctAnswer = "vine";
                    break;
                case 4:
                    questionText = "What are the parts of a flower that attract pollinators like insects and birds?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,22); // Player answered correctly
                } else {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the male reproductive organ of a flower that produces pollen?";
                    correctAnswer = "stamen";
                    break;
                case 1:
                    questionText = "What is the giant, swirling storm system at the center of a low-pressure zone that brings strong winds and heavy precipitation?";
                    correctAnswer = "cyclone";
                    break;
                case 2:
                    questionText = "What are the elements that are typically good conductors of heat and electricity, shiny, malleable?";
                    correctAnswer = "metal";
                    break;
                case 3:
                    questionText = "What is the vast, slow-moving mass of ice that covers a large landmass and flows under its own weight?";
                    correctAnswer = "glacier";
                    break;
                case 4:
                    questionText = "What is the term for the increase of temperature of the Earth's atmosphere and oceans caused by human activities?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,27); // Player answered correctly with high damage
                } else {
                    handleAnswer(false); // Player answered incorrectly
                }
            });
