document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        function quitGame() {
            ...
            window.location.href = "../../map4/index.html";
        }
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What are fish used for swimming?";
                    correctAnswer = "fins";
                    break;
                case 1:
                    questionText = "What is a warm-blooded animal that has fur or hair and nurses its young with milk?";
                    correctAnswer = "mammal";
                    break;
                case 2:
                    questionText = "What is a cold-blooded animal that has scales and lays eggs?";
                    correctAnswer = "reptile";
                    break;
                case 3:
                    questionText = "What is the part of the flower that develops into a fruit after fertilization?";
                    correctAnswer = "ovary";
                    break;
                case 4:
                    questionText = "What is the tropical fruit with a spiky outer shell and a sweet, creamy flesh?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,23); // Player answered correctly
                } else {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the long, flexible organ used by some snakes to sense their surroundings?";
                    correctAnswer = "tongue";
                    break;
                case 1:
                    questionText = "Which fruit is a good source of potassium, essential for maintaining healthy blood pressure?                    ";
                    correctAnswer = "banana";
                    break;
                case 2:
                    questionText = "what is the part of the plant responsible for photosynthesis?";
                    correctAnswer = "leaf";
                    break;
                case 3:
                    questionText = "What is the structure that anchors the plant to the ground and absorbs water and nutrients from the soil?";
                    correctAnswer = "root";
                    break;
                case 4:
                    questionText = "What is a plant with woody stems and branches that lives for many years?                    ";
                    correctAnswer = "tree";
                    break;
                default:
                    questionText = "What is the long, flexible organ used by some snakes to sense their surroundings?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,28); // Player answered correctly with high damage
                } else {
                    handleAnswer(false); // Player answered incorrectly
                }
            });
