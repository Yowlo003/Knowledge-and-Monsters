    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        if (isCorrect) {
            ...
            if (damageAmount !== null) {
                ...
                const damage = Math.floor(Math.random() * 30) + 1; // Random damage between 1 and 20
                enemyHealth -= damage;
            }
            if (enemyHealth < 0) {
            ...
            if (playerAnswer !== null) {
                ...
                if (damageType === 'low') {
                    damage = 13; // High damage
                    blinkplayer()

                    const highGifContainer = document.getElementById('plow-gif-container');
                    highGifContainer.innerHTML = '<img src="Assets/phit1.gif" alt="Correct High GIF" width="450">';
        ...
        function quitGame() {
            ...
            window.location.href = "../../map2/index.html";
        }
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is a naturally occurring solid aggregate of one or more minerals?";
                    correctAnswer = "rock";
                    break;
                case 1:
                    questionText = "What is the network of specialized cells that transmit messages throughout the body?";
                    correctAnswer = "nervous system";
                    break;
                case 2:
                    questionText = "What is the muscular pump that keeps blood flowing throughout the body?";
                    correctAnswer = "heart";
                    break;
                case 3:
                    questionText = "What are the paired organs that filter waste products from the blood?";
                    correctAnswer = "kidney";
                    break;
                case 4:
                    questionText = "What is the process by which the body breaks down food into nutrients?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,25); // Player answered correctly
                } else {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What are the building blocks of proteins in the body?";
                    correctAnswer = "amino acids";
                    break;
                case 1:
                    questionText = "What is the genetic material found in the nucleus of cells that determines traits?";
                    correctAnswer = "dna";
                    break;
                case 2:
                    questionText = "What is the complex network of blood vessels that carries blood throughout the body?";
                    correctAnswer = "circulatory system";
                    break;
                case 3:
                    questionText = "What is the process by which the body takes in oxygen and releases carbon dioxide?";
                    correctAnswer = "respiration";
                    break;
                case 4:
                    questionText = "What major medical breakthrough allowed doctors to see inside the body without surgery?";
                    correctAnswer = "x-ray";
                    break;
                default:
                    questionText = "What are the building blocks of proteins in the body?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,30); // Player answered correctly with high damage
                } else {
                    handleAnswer(false); // Player answered incorrectly
                }
            });
