document.addEventListener('DOMContentLoaded', function() {
    ...
    window.onload = function() {
        ...
        }, 2200); // Adjust the timeout duration as needed (in milliseconds)
    };
    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        if (isCorrect) {
            ...
            if (damageAmount !== null) {
                ...
                const damage = Math.floor(Math.random() * 29) + 1; // Random damage between 1 and 20
                enemyHealth -= damage;
            }
            if (enemyHealth < 0) {
        ...
        function quitGame() {
            ...
            window.location.href = "../../map3/index.html";
        }
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is a wearable device that tracks health data such as heart rate, steps taken, and sleep patterns?";
                    correctAnswer = "fitness tracker";
                    break;
                case 1:
                    questionText = "What basic building blocks do both human and animal bodies share?";
                    correctAnswer = "cells";
                    break;
                case 2:
                    questionText = "What essential process do both humans and animals need for energy?";
                    correctAnswer = "cellular respiration";
                    break;
                case 3:
                    questionText = "What important system do both humans and animals have to transport nutrients and oxygen throughout their bodies?";
                    correctAnswer = "circulatory system";
                    break;
                case 4:
                    questionText = "What is the process of breaking down food into usable nutrients common to both humans and animals?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,24); // Player answered correctly
                } else {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the waste product of cellular respiration eliminated by both humans and animals?";
                    correctAnswer = "carbon dioxide";
                    break;
                case 1:
                    questionText = "What is the muscular pump responsible for blood flow in both humans and animals?";
                    correctAnswer = "heart";
                    break;
                case 2:
                    questionText = "What is the network of specialized cells transmitting messages throughout the body in both humans and animals?";
                    correctAnswer = "nervous system";
                    break;
                case 3:
                    questionText = "What is the process of taking in oxygen and releasing carbon dioxide common to both humans and animals?";
                    correctAnswer = "respiration";
                    break;
                case 4:
                    questionText = "What is the basic unit of heredity carrying genetic information, present in both humans and animals?";
                    correctAnswer = "genes";
                    break;
                default:
                    questionText = "What is the waste product of cellular respiration eliminated by both humans and animals?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,29); // Player answered correctly with high damage
                } else {
                    handleAnswer(false); // Player answered incorrectly
                }
            });
