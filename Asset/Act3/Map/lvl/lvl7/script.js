    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "Which chamber of the heart pumps oxygen-rich blood to the body?";
                    correctAnswer = "left ventricle";
                    break;
                case 1:
                    questionText = "What is the smallest type of blood vessel?";
                    correctAnswer = "capillary";
                    break;
                case 2:
                    questionText = "Which side of the heart deals with oxygen-rich blood? (left or right)";
                    correctAnswer = "left";
                    break;
                case 3:
                    questionText = "What is the term for the circulation of blood through the lungs?";
                    correctAnswer = "pulmonary";
                    break;
                case 4:
                    questionText = "Which blood vessels have valves to prevent backflow?";
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "Which component of blood carries hormones and nutrients?";
                    correctAnswer = "plasma";
                    break;
                case 1:
                    questionText = "What is the term for the tiny blood vessels that connect arteries and veins?";
                    correctAnswer = "capillaries";
                    break;
                case 2:
                    questionText = "What is the main gas exchanged for oxygen in the lungs?";
                ...
                case 3:
                    ...
                    break;
                case 4:
                    questionText = "Which planet is the fourth from the Sun?";
                    correctAnswer = "mars";
                    break;
                default:
                    questionText = "Which component of blood carries hormones and nutrients?";
