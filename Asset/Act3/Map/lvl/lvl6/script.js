document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        function proceedToNextLevel() {
            ...
            window.location.href = "../lvl7/index.html";
        }

        function quitGame() {
            // Implement quit logic here
            window.location.href = "../../map7/index.html";
        }
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "This is a muscular organ located in the chest cavity. It pumps blood throughout the body.";
                    correctAnswer = "heart";
                    break;
                case 1:
                    questionText = "These carry oxygen-rich blood away from the heart to the body's tissues";
                    correctAnswer = "arteries";
                    break;
                case 2:
                    questionText = "These are tiny blood vessels where the exchange of oxygen, carbon dioxide, nutrients occurs between the blood and the body's cells.";
                    correctAnswer = "apillaries";
                    break;
                case 3:
                    questionText = "These carry oxygen-poor blood back to the heart";
                    correctAnswer = "veins";
                    break;
                case 4:
                    questionText = "Which chamber of the heart receives oxygen-poor blood from the body?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,20); // Player answered correctly
                } else {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "This travels from the main artery to larger and smaller arteries and into the capillary network.";
                    correctAnswer = "blood";
                    break;
                case 1:
                    questionText = "These are part of the immune system and help fight infections";
                    correctAnswer = "white blood cells";
                    break;
                case 2:
                    questionText = "Which component of blood aids in clotting?";
                    correctAnswer = "platelets";
                    break;
                case 3:
                    questionText = "In which part of the circulatory system does oxygen-poor blood get reoxygenated?";
                    correctAnswer = "lungs";
                    break;
                case 4:
                    questionText = "What is the largest artery in the human body?";
                    correctAnswer = "aorta";
                    break;
                default:
                    questionText = "This travels from the main artery to larger and smaller arteries and into the capillary network.";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,25); // Player answered correctly with high damage
                } else {
                    handleAnswer(false); // Player answered incorrectly
                }
            });
