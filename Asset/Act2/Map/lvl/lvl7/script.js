document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        function proceedToNextLevel() {
            ...
            window.location.href = "../lvl8/index.html";
        }

        function quitGame() {
            // Implement quit logic here
            window.location.href = "../../map8/index.html";
        }
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the world's most popular sport?";
                ...
                case 1:
                    ...
                    break;
                case 2:
                    questionText = "What is the largest living organism on Earth?";
                    correctAnswer = "great barrier reef";
                    break;
                case 3:
                    questionText = "What is the name of the social media platform known for short-form videos?";
                    correctAnswer = "tiktok";
                    break;
                case 4:
                    questionText = "What are the three primary colors used in painting?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,19); // Player answered correctly
                } else {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the period in art history characterized by a focus on religious themes?";
                    correctAnswer = "medieval art";
                    break;
                case 1:
                    questionText = "What is a famous Renaissance artist known for his painting of the Sistine Chapel ceiling?";
                    correctAnswer = "michelangelo";
                    break;
                case 2:
                    questionText = "What is a type of computer network that connects devices on a global scale?";
                    correctAnswer = "internet";
                    break;
                case 3:
                    questionText = "What is a form of renewable energy that uses wind to generate electricity?";
                    correctAnswer = "wind power";
                    break;
                case 4:
                    questionText = "What is a global navigation satellite system that provides location and time information?";
                    correctAnswer = "gps";
                    break;
                default:
                    questionText = "What is the period in art history characterized by a focus on religious themes?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,24); // Player answered correctly with high damage
                } else {
                    handleAnswer(false); // Player answered incorrectly
                }
            });
