    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "On a standard traffic light, is the green on the top or bottom?";
                    correctAnswer = "bottom";
                    break;
                case 1:
                    questionText = "What element does the chemical symbol Au stand for?";
                    correctAnswer = "gold";
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    questionText = "What is the more popular name for the portrait officially titled “La Gioconda,” painted in Florence in 1503?";
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "Who is the Greek God of music?";
                    correctAnswer = "apollo";
                    break;
                case 1:
                    questionText = "What is the human body largest organ?";
                    correctAnswer = "skin";
                    break;
                case 2:
                    questionText = "What is the deadliest mammal?";
                    correctAnswer = "hippo";
                    break;
                case 3:
                    questionText = "What is the deadliest animal in the world?";
                    correctAnswer = "mosquito";
                    break;
                case 4:
                    questionText = "In Greek mythology, who was known as the messenger of the gods?";
