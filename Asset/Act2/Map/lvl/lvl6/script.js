    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the process by which living things obtain nutrients from food?";
                    correctAnswer = "digestion";
                    break;
                case 1:
                    questionText = "What is the scientific study of genes and heredity?";
                    correctAnswer = "genetics";
                    break;
                case 2:
                    questionText = "What is the basic unit of heredity that carries genetic information?";
                    correctAnswer = "gene";
                    break;
                case 3:
                    questionText = "What is the scientific study of Earth and its rocks?";
                    correctAnswer = "geology";
                    break;
                case 4:
                    questionText = "What is the alternative energy source that uses the sun's energy?";
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the scientific study of behavior and mental processes?";
                    correctAnswer = "psychology";
                    break;
                case 1:
                    questionText = "What is the theory that explains how species change over time?";
                    correctAnswer = "evolution";
                    break;
                case 2:
                    questionText = "What is the outermost layer of the Earth's atmosphere?";
                    correctAnswer = "exosphere";
                    break;
                case 3:
                    questionText = "What is the branch of mathematics that deals with shapes and their properties?";
                    correctAnswer = "geometry";
                    break;
                case 4:
                    questionText = "What is the result of dividing the numerator by the denominator in a fraction?";
