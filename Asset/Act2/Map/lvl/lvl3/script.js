        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    ...
                    break;
                case 1:
                    questionText = "What covers most of the Earth's surface?";
                    correctAnswer = "water";
                    break;
                case 2:
                    questionText = "What kind of animal has feathers and can fly?";
                    correctAnswer = "bird";
                    break;
                case 3:
                    questionText = "What mixes with water to make mud?";
                    correctAnswer = "dirt";
                    break;
                case 4:
                    questionText = "What continent is the Great Wall of China on?";
                    correctAnswer = "china";
                    break;
                default:
                    questionText = "What is the tallest mountain in the world?";
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "In what city were the first infections of COVID-19 discovered?";
                    correctAnswer = "wuhan";
                    break;
                case 1:
                    questionText = "What is the study of history called?";
                    correctAnswer = "history";
                    break;
                case 2:
                    questionText = "What is a group of people who live together and share a culture called?";
                    correctAnswer = "community";
                    break;
                case 3:
                    questionText = "What is a word that describes something big?";
                    correctAnswer = "giant";
                    break;
                case 4:
