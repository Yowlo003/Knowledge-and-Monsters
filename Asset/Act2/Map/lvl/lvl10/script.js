document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        if (isCorrect) {
            ...
            if (playerAnswer !== null) {
                ...
                if (damageType === 'low') {
                    ...
                    damage = 34; // High damage
                    blinkplayer()

                    const highGifContainer = document.getElementById('phigh-gif-container');
                    highGifContainer.innerHTML = '<img src="Assets/phit2.gif" alt="Correct High GIF" width="700">';
        ...
        function proceedToNextLevel() {
            ...
            window.location.href = "../../../../Act2/Cutscenes/C2_End/index.html";
        }
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What are the complex molecules that make up living things and carry out specific functions?";
                    correctAnswer = "proteins";
                    break;
                case 1:
                    questionText = "What is the organ system responsible for transporting blood throughout the body?";
                    correctAnswer = "circulatory system";
                    break;
                case 2:
                    questionText = "What is the kingdom of living things that includes bacteria and archaea?";
                    correctAnswer = "monera";
                    break;
                case 3:
                    questionText = "What is the table that organizes elements based on their properties?";
                    correctAnswer = "periodic table";
                    break;
                case 4:
                    questionText = "What is a chemical reaction where two or more substances combine to form a new substance?";
            ...
            switch (questionIndex) {
                case 0:
                    ...
                    break;
                case 1:
                    questionText = "What is the branch of physics that studies the motion of objects and the forces that cause them to move?";
                    correctAnswer = "mechanics";
                    break;
                case 2:
                    questionText = "What is the theory that explains the behavior of matter and energy at the atomic and subatomic level?";
                    correctAnswer = "quantum mechanics";
                    break;
                case 3:
                    questionText = "What is the molten rock layer that lies beneath the Earth's crust?";
                    correctAnswer = "mantle";
                    break;
                case 4:
                    questionText = "What is the large, slow-moving rock formation that floats on the Earth's mantle?";
                    correctAnswer = "tectonic plate";
                    break;
                default:
                    questionText = "What is the unit of measurement for force?";
                    correctAnswer = "newton";
