    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the largest living land animal?";
                    correctAnswer = "elephant";
                    break;
                case 1:
                    questionText = "What is the chemical element that makes up most of the Earth's atmosphere?";
                    correctAnswer = "nitrogen";
                    break;
                case 2:
                    questionText = "What is the name of the mythical labyrinth designed by Daedalus in Greek mythology?";
                    correctAnswer = "labyrinth";
                    break;
                case 3:
                    questionText = "What is a story passed down from generation to generation, often involving gods or supernatural beings?";
                    correctAnswer = "myth";
                    break;
                case 4:
                    questionText = "What is the sport involving two players hitting a small, hollow ball over a net with rackets?";
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the process by which plants absorb water through their roots?";
                    correctAnswer = "osmosis";
                    break;
                case 1:
                    questionText = "What is the process by which sound waves travel?";
                    correctAnswer = "vibration";
                    break;
                case 2:
                    questionText = "What is the layer of the atmosphere that protects Earth from harmful ultraviolet radiation from the sun?";
                    correctAnswer = "ozone layer";
                    break;
                case 3:
                    questionText = "What is the process by which water changes from a gas to a liquid?";
                    correctAnswer = "condensation";
                    break;
                case 4:
                    questionText = "What is the traditional Chinese celebration that marks the beginning of a new year on the lunisolar calendar?";
