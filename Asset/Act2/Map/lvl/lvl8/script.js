document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleAnswer(isCorrect, damageAmount = null) {
        ...
        function proceedToNextLevel() {
            ...
            window.location.href = "../lvl9/index.html";
        }
    ...
    function startGame() {
        ...
        if (questionType === 'low') {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the largest island in the Philippines?";
                    correctAnswer = "luzon";
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    questionText = "What is the national hero of the Philippines?";
                    correctAnswer = "jose rizal";
                    break;
                case 4:
                    questionText = "What is the traditional Philippine dance known for its graceful movements and use of fans?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,18); // Player answered correctly
                } else {
            ...
            switch (questionIndex) {
                case 0:
                    questionText = "What is the name of the active volcano located near Legazpi City?";
                    correctAnswer = "mayon volcano";
                    break;
                case 1:
                    questionText = "What is the term for the terraces carved into the mountainsides of Ifugao?";
                    correctAnswer = "banaue rice terraces";
                    break;
                case 2:
                    questionText = "What is the second-largest island in the Philippines?";
                    correctAnswer = "mindanao";
                    break;
                case 3:
                    questionText = "What is a popular Filipino dessert made with shaved ice, sweetened condensed milk, and various toppings?";
                    correctAnswer = "halo-halo";
                    break;
                case 4:
                    questionText = "What is a popular Filipino animal symbol of strength and resilience?";
            ...
            submitButton.addEventListener('click', function() {
                ...
                if (playerAnswer.toLowerCase() === correctAnswer) {
                    handleAnswer(true,23); // Player answered correctly with high damage
                } else {
                    handleAnswer(false); // Player answered incorrectly
                }
            });
